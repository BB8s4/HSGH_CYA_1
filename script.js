  ...
  function changeText(){
    ...
    switch(nameInput.value) {
        ...
        case "소백":
          ...
          document.getElementById("resultText").innerHTML = "<div> 청명은 젊은 무인들 중, 자신의 말을 가장 잘 따르는 설소백에게 부탁하기로 했다.</div> <div> 끄으음&hellip; 저 꼬맹이의 혼삿길을 막는 것 같아서 죄책감이 들긴 하는데, 그래도 일단 나 
